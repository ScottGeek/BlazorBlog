    ...
    public class AddOrUpdateBlogValidator : AbstractValidator<AddOrUpdateBlogCommand>
    {
        ...
        public AddOrUpdateBlogValidator()
        {
            ...
            RuleFor(x => x.Title)
                ...
                .MaximumLength(MaxLengths.Blogs.Title).WithMessage("The title must be less than {MaxLength} characters");

            RuleFor(x => x.Description)
                .NotEmpty().WithMessage("The description is required")
                .MaximumLength(MaxLengths.Blogs.Description).WithMessage("The description must be less than {MaxLength} characters");
